  ...
  class TrackerService {
    static const String _storageKeyPrefix = 'tracker_entries_';
    static const String _disclaimerKey = 'tracker_disclaimer_accepted';
    ...
    static const String _day7PopupKey = 'day7_popup_shown_';
    ...
    static Future<bool> hasShownDay7Popup(String userId) async {
      try {
        final prefs = await SharedPreferences.getInstance();
        return prefs.getBool('$_day7PopupKey$userId') ?? false;
      } catch (e) {
    ...
    static Future<void> markDay7PopupShown(String userId) async {
      try {
        final prefs = await SharedPreferences.getInstance();
        await prefs.setBool('$_day7PopupKey$userId', true);
